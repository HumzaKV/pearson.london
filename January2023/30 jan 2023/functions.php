            ...
            <div class="packages-container">
                ...
                <div class="package-content">
                    ...
                    <div class="package-duration">
                        <span><?php echo $price; ?></span> <span><?php echo $duration; ?></span>
                    </div>
...
add_action( 'wp_footer', 'pkg_data_wp_footer' );
function pkg_data_wp_footer() {
?>
    <script>
    jQuery(function($) {

        $(document).on("click", "a.pkg_btn", function () {
            let frmMain = $('#gform_wrapper_3'),
                pkgTitle = frmMain.find('#input_3_22').val(),
                pkgProd = frmMain.find('#field_3_23');

            frmMain.find('#input_3_22')
                .prop('readonly', true);

            pkgProd.find('[name="input_23.1"]').val( pkgTitle );
        });

        $(document).on("click", "a.package-btn", function () {
            let frmMain = $('#gform_wrapper_3'),
                pkgWrapper = $(this).parents('.packages-container'),
                pkgTitle = pkgWrapper.find('.package-content h4').text(),
                pkgProd = frmMain.find('#field_3_23');
            ...
            // pkgLabel.html( pkgLabel.html().replace('{embed_post:post_title}', pkgTitle) );
            pkgProd.find('[name="input_23.1"]').val( pkgTitle );
        });
